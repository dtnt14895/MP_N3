    ...
    <main class="form-main">
        ...
        ?>
            ...
            <form action="../controllers/users-controller.php" method="post">
                <div>
                    <input type="text" name="email" id="fullname" placeholder="Email">
                </div>

                <div>
                    <input type="password" name="pssword" id="pssword" placeholder="Password">
                </div>
            ...
            <span>Already a member? <a href="../views/login.php">Login</a></span>
        </section>
